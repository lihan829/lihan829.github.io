...
\textbf{Theoretical} 
& Phonology · Phonetics · Tone and Prosody · Autosegmental Representations \\

\textbf{Computational} 
& Formal Language Theory · Learnability · Language Modeling \\

\textbf{Experimental} 
& Bilingual Speech · Atypical Speech · Speech Production and Perception \\
...
\cvsection{Education}
\noindent
\textbf{Stony Brook University}, Stony Brook, NY \hfill 2021–2026(Expected) \\  
...
\begin{etaremune}[itemsep=0.8em]
    ...
    \item Tetzloff, K.A. \& \textbf{Li, H.} (2026). \textit{Gradient bilingual phonotactic judgments reflect dominance-weighted grammar mixture.} Talk at Annual Meeting on Phonology (AMP), University of Maryland, College Park.
...
\item Young Writers Scholarship, IACS Stony Brook University (\$500)  \hfill 2026
    \item Society for Computation in Linguistics (SCiL) Conference Scholarship (\$800) \hfill 2026
\item Stony Brook Foundation Board of Trustees Dissertation Endowed Fellowship (\$15,000) \hfill 2026
\item Junior Researcher Award, IACS Stony Brook University (\$34,000)  \hfill 2024 -2026
...
\cvsubsection{CUNY Quees College}
\begin{itemize}[itemsep=0em, parsep=0.2em, topsep=0em]
\item \textbf{Instructor} - \textbf{Department of Linguistics TESOL and Communication Sciences \& Disorders}  
\begin{itemize}[itemsep=0em, parsep=0.2em, topsep=0em]
    \item LCD 101   \quad Introduction to Linguistics \hfill Fall 2026
    \item LCD 151   \quad Methods in Computational Linguistics \hfill Fall 2026\\
\end{itemize}
\end{itemize}

\cvsubsection{\sc{SUNY Stony Brook University}}
...
\begin{itemize}[itemsep=0em, parsep=0.3em, topsep=0em]
    \item Research Assistant to Dr.\ Thomas Graf, developing course for \textit{Math Methods} \hfill Summer 2022
    \item Research Assistant to Dr.\ John Bailyn at V-NYI  \hfill Spring 2026\\
\end{itemize}
